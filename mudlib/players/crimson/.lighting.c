#include "handshake.h"
/*   This is the scroll of CRIMSON.  Do not copy! Do not take! Do not touch! */
/*   If this file or anything that looks like this file is found in your     */
/*   possesion, you WILL be punished!                                        */
string long;
int is_npc;
int charges;
int magic;
...
id(str) {
    return str == "scroll" || str == "black scroll";
}

no_find(str) {
   if (str == "scroll" || str == "black scroll") {
   write("What?\n");
   return 1; 
   }
}
...
strike(str) {
     ...
     tell_object(liv, name + " hit you with a lighting bolt!\n");
     write("You invoke the runes from the scroll and hit " +targ+ " with a lighting bolt!\n");
     write("You massacred " +targ+ " into small fragments.\n");
     say(name + " hit " +targ+ " with a lighting bolt!\n");
     call_other(liv, "hit_player", 33);
